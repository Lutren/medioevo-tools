...
Minimum app avg FPS: 60.17
All scenarios pass threshold: true

| Scenario | external avg FPS | external p95 ms | app avg FPS | app p95 ms | dropped | threshold |
|---|---:|---:|---:|---:|---:|---|
| high_iso3d_operational | 60 | 16.8 | 60.18 | 16.8 | 0 | PASS |
| beautiful_vermeer_city | 60 | 16.7 | 60.18 | 16.7 | 0 | PASS |
| debug_osit_formula_lab | 60 | 16.8 | 60.17 | 16.8 | 0 | PASS |
