...
- `lobby_alejandria`: `C:\Users\L-Tyr\OneDrive\Escritorio\Lobby de Alejandria`

## Resumen

- Archivos registrados: `18`
- Duplicados exactos detectados: `0` archivos en grupos duplicados
...
| `duat-geodia` | 2 |
| `privado-bloqueado` | 1 |
| `psi-observacionismo` | 2 |

## Decisiones

| decision | archivos |
|---|---:|
| `ABSORB_AS_RESEARCH_BOUNDARY` | 1 |
| `ABSORB_TO_ATLAS` | 16 |
| `BLOCK_KEEP_PRIVATE` | 1 |
